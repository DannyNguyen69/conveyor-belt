...
class ESP32ControlGUI:
    ...
    def setup_gui(self):
        ...
        self.camera_label = tk.Label(left_frame, text="Camera not started", 
        ...
        self.connect_btn = ttk.Button(conn_buttons, text="Connect", 
                                     command=self.connect_esp32)
        self.connect_btn.pack(side=tk.LEFT, padx=(0, 5))
        
        self.disconnect_btn = ttk.Button(conn_buttons, text="Disconnect", 
